...
title: Axions
katex: True
permalink: /posts/axions/
toc: True
toc_sticky: True
---

The axion is a hypothetical type of particle that was proposed in the 1970s as a solution to the strong CP problem in particle 
...
Because the axion is weakly interacting, it would be difficult to detect directly. However, in certain mass (ultra-light, see below) and coupling regimes axions could still 
have significant effects on the universe, such as influencing the large-scale structure of galaxies and contributing to the cosmic microwave background radiation.

There are ongoing efforts to detect axions either directly in experiments like ADMX or indirectly through its effects on astrophysical and cosmological phenomena, 
such as the observation of the cosmic microwave background by experiments like Planck and BICEP/Keck. However, so far there has been no direct 
detection of axions.
